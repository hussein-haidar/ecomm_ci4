<div class="box">
  <div class="box-header">
    <a href="<?= base_url('superadmin_kebijakan_platform/add_syarat') ?>" class="btn btn-sm">
      <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Syarat &amp; Ketentuan
    </a>
    <a href="<?= base_url('superadmin_kebijakan_platform/faq') ?>" class="btn btn-sm">
        ...
        <tbody>
          ...
          <?php foreach ($skt as $value) : ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('superadmin_kebijakan_platform/edit_syarat/' . $value['id_skt']) ?>" class="btn btn-xs btn-warning">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="<?= base_url('superadmin_kebijakan_platform/delete_syarat/' . $value['id_skt']); ?>" class="btn btn-success">Hapus</a>
