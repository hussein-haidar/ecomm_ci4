<div class="box">
    <div class="box-header">
        <a href="<?= base_url('pemilik_kelola_data/satuan_produk') ?>" class="btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali ke Daftar Satuan</a>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($data_satuan_dihapus as $key => $value) {
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $value['satuan_produk']; ?></td>
                            <td>
                                <a href="<?= base_url('pemilik_kelola_data/restore_satuan/' . $value['id_satuan']) ?>" class="btn btn-success  btn-xs">
...
<!-- Modal Delete -->
<?php foreach ($data_satuan_dihapus as $value) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('pemilik_kelola_data/delete_hard_satuan/' . $value['id_satuan']); ?>" class="btn btn-success">Hapus</a>
