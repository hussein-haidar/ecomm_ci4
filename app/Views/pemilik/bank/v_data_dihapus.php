<div class="box">
    <div class="box-header">
        <a href="<?= base_url('pemilik_kelola_data/bank') ?>" class="btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali ke Daftar Bank</a>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($data_bank_dihapus as $key => $value) {
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            ...
                            <td><?= $value['no_rek']; ?></td>
                            <td>
                                <a href="<?= base_url('pemilik_kelola_data/restore_bank/' . $value['id_bank']) ?>" class="btn btn-success btn-xs">
...
<!-- Modal Delete -->
<?php foreach ($data_bank_dihapus as $value) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('pemilik_kelola_data/delete_hard_bank/' . $value['id_bank']); ?>" class="btn btn-success">Hapus</a>
