<div class="box">
    <div class="box-header">
        <a href="<?= base_url('pemilik_kelola_data/motif') ?>" class="btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali ke Daftar Motif</a>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php $no = 1;
                    foreach ($data_varian_dihapus as $key => $value) {
                    ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td><?= $value['varian_produk']; ?></td>
                            <td>
                                <a href="<?= base_url('pemilik_kelola_data/restore_varian/' . $value['id_varian']) ?>" class="btn btn-success btn-xs">
...
<!-- Modal Delete -->
<?php foreach ($data_varian_dihapus as $value) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?= base_url('pemilik_kelola_data/delete_hard_varian/' . $value['id_varian']); ?>" class="btn btn-success">Hapus</a>
