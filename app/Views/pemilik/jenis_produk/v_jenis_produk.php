<div class="box">
  <div class="box-header">
    <a href="<?= base_url('pemilik_kelola_data/add_jenis') ?>" class="btn btn-sm">
      <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data
    </a>
    <a href="<?= base_url('pemilik_kelola_data/data_jenis_dihapus') ?>" class="btn btn-sm">Lihat Data Dihapus</a>
  </div>
  ...
  <div class="box-body">
    ...
    <div class="table-responsive">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          <?php $no = 1; ?>
          <?php foreach ($jenis_produk as $value) : ?>
            <tr>
              <td><?= $no++; ?></td>
              ...
              <td>
                <?php if ($value['deleted_at'] == 0) : ?>
                  ...
                  <a href="<?= base_url('pemilik_kelola_data/edit_jenis/' . $value['id_jenis']) ?>" class="btn btn-xs btn-warning">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="<?= base_url('pemilik_kelola_data/delete_jenis/' . $value['id_jenis']); ?>" class="btn btn-success">Hapus</a>
