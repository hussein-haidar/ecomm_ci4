    ...
    <div class="col-md-6">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php echo form_open_multipart('pemilik_kelola_data/update_jenis/' . $jenis_produk['id_jenis']); ?>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url('pemilik_kelola_data/jenis') ?>" class="btn btn-primary">Kembali</a>
                </div>
                <?php echo form_close() ?>
            </div>
        </div>
