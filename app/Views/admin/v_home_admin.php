...
<div class="card-body">
    <marquee style="font-family:arial; font-size:30px; color:#000000;">
        Selamat Datang Di <?= htmlspecialchars($title) ?>
    </marquee>
</div>
<br>
...
<div class="box box-solid">
    <div class="box-header">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="card border-left-success shadow mb-3 p-3 bg-light">
                            ...
                            <p><?= $produk_nilai_tertinggi['nama_produk'] ?? '-' ?> (Rp. <?= number_format($produk_nilai_tertinggi['total'] ?? 0, 0, ',', '.') ?>)</p>
                        </div>
                        <div class="card border-left-danger shadow mb-3 p-3 bg-light">
                            ...
                            <p><?= $produk_nilai_terendah['nama_produk'] ?? '-' ?> (Rp. <?= number_format($produk_nilai_terendah['total'] ?? 0, 0, ',', '.') ?>)</p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            const nilaiData = <?= json_encode($grafik_nilai) ?>;
