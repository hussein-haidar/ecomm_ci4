<div class="box">
  <div class="box-header">
    <a href="<?= base_url('kebijakan_toko/add_faq') ?>" class="btn btn-sm">
      <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah FAQ
    </a>
    <a href="<?= base_url('kebijakan_toko/syarat') ?>" class="btn btn-sm">
        ...
        <tbody>
          ...
          <?php foreach ($faq as $value) : ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url('kebijakan_toko/edit_faq/' . $value['id_faq']) ?>" class="btn btn-xs btn-warning">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="<?= base_url('kebijakan_toko/delete_faq/' . $value['id_faq']); ?>" class="btn btn-success">Hapus</a>
