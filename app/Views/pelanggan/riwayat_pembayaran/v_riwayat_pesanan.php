                 ...
                 <table class="table table-bordered">
                     ...
                     <tbody>
                         <?php if (empty($pembayaran)): ?>
                             <tr>
                                 <td colspan="6" class="text-center">Pembelian anda kosong, tidak ada yang dibeli.</td>
                             </tr>
                         <?php else: ?>
                             <?php $no = 1; ?>
...
<td>
                                        <?php
                                            $tanggal_db = $value['waktu_pembayaran'] ?? $value['waktu_pembelian'] ?? null;
                                            if ($tanggal_db && $tanggal_db != '0000-00-00 00:00:00'):
                                                $tanggal = strtotime($tanggal_db);
