...
-- Host: ::1
-- Generation Time: 2025-07-12 18:14:51
-- PHP Version: 8.2.12
...
INSERT INTO `tbl_data_kurir` (`id_kurir`, `sesi_user`, `jenis_kurir`, `ongkir`, `deleted_at`) VALUES
    ...
    ('3', 'Tantowi', 'Gosend', '2200.00', '0'),
    ('4', 'Tantowi', 'Kurir Internal', '1700.00', '0'),
    ('5', 'Tantowi', 'JNE', '2350.00', '0'),
    ('6', 'Tantowi', 'JNT', '2300.00', '0');
...
INSERT INTO `tbl_data_pelanggan` (`id_pelanggan`, `sesi_user`, `email`, `password`, `nama_pelanggan`, `jenis_kelamin`, `tanggal_lahir`, `no_telpon`, `longitude`, `latitude`, `alamat`, `foto_pelanggan`, `level`, `last_login`) VALUES
    ('6', 'Tantowi', 'ahmad@gmail.com', '1234', 'Ahmad W', 'L', '1990-06-05', '0898988787875', '109.636623843625', '-6.902583025180465', 'Samborejo, Tirto, Kab.Pekalongan, Jateng', '1736002127_f547bbf163f1afaa63eb.jpg', '3', '2025-07-10 19:09:32'),
...
INSERT INTO `tbl_data_user` (`id_user`, `username`, `password`, `nama_lengkap`, `tampilkan_varian`, `sesi_user`, `nama_title`, `notelpon_user`, `jobdesk_user`, `level`, `foto_user`, `last_login`) VALUES
    ('4', 'tantowi123', '1234', 'Tantowi', '1', 'Tantowi', 'Pemilik', '092098492829', 'Pemilik Toko', '1', '1736913528_ce14a2c09b0527014d3e.png', '2025-07-12 18:14:21'),
    ('5', 'admin', '1234', 'Ahmad', '1', 'Tantowi', 'Administrator', '089849859894', 'Mengelola stok', '2', '1736913412_0dd2339b7b8eac8cd5df.png', '2025-07-12 18:12:38'),
    ('6', 'agus123', '1234', 'Agus', '1', 'Agus', 'Pemilik', '0989086063', 'Pemilik  Majo Makmur', '1', '1743604603_8bca7e7b2e617c578e41.jpg', '2025-06-28 13:18:48'),
...
INSERT INTO `tbl_stok_produk` (`id_stok`, `sesi_user`, `kode_stok`, `jumlah_stok_produk`, `satuan_produk`, `tanggal_masuk_produk`, `nama_produk`, `jenis_produk`, `harga_produk`, `ukuran_produk`, `berat_produk`, `satuan_berat`, `total_berat`, `total_harga`) VALUES
    ...
    ('53', 'Tantowi', 'SKB-003', '2', 'Item', '2025-02-03', 'Kemeja Batik Lengan Pendek Anak Cowok Motif Waru', 'Kemeja Hem Batik Anak Cowok', '76000.00', 'S-M-L-XL-XXL', '500.00', 'Gram', '1000.00', '152000.00'),
